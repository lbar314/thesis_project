...
Topology::Topology():TObject(), fPattern(), fUID(0), fRs(0), fCs(0), fFiredPixels(0),
		     fxCOGPix(0.), fzCOGPix(0.), fxCOGshift(0.), fzCOGshift(0.), fHash(0), fFreq(0.), fCounts(0),
		     fGroupID(-1), fHxA(0), fHxB(0), fHzA(0), fHzB(0), fFlag(0), fPattID(-1){
...
Topology::Topology(const AliITSMFTClusterPix &cluster):TObject(), fFiredPixels(0),fxCOGPix(0.), fzCOGPix(0.), fxCOGshift(0.), fzCOGshift(0.), fHash(0), fFreq(0.), fCounts(0),fGroupID(-1), fHxA(0), fHxB(0), fHzA(0), fHzB(0), fFlag(0), fPattID(-1){//UniqueID of the argument must already have been set
...
/*
	Topology::Topology(const TBits &top2copy):TObject(),fPattern(top2copy){//UniqueID of the argument must already have been set
	  ...
	  //Defining COG position	void Topology::DeleteHistos(){
